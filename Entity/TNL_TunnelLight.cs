...
namespace NbIotCmd.Entity
{
    ...
    public class TNL_TunnelLight  
    {
        ...
        public double? VoltageHighValue_NR { get; set; }
        public double? VoltageLowValue_NR { get; set; }
        public double? CurrentHighValue_NR { get; set; }
        public double? CurrentLowValue_NR { get; set; }
        ...
        public double? DimmingFactor_NR { get; set; }
        ...
        public double? NorminalPower_NR { get; set; }
        ...
        public double? TemperatureHigh_NR { get; set; }
        public double? TemperatureLow_NR { get; set; }
